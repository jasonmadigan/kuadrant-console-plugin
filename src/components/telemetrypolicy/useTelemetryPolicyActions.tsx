...
const useTelemetryPolicyActions = (obj: K8sResourceCommon): ExtensionHookResult<Action[]> => {
  ...
  const actions = React.useMemo<Action[]>(() => {
    if (!obj || obj.kind !== 'TelemetryPolicy') return [];
    ...
    const actionsList: Action[] = [
      {
        id: 'edit-labels-telemetrypolicy',
        label: 'Edit labels',
        cta: launchLabelsModal,
        accessReview: updateAccess,
      },
      {
        id: 'edit-annotations-telemetrypolicy',
        label: 'Edit annotations',
        cta: launchAnnotationsModal,
        accessReview: updateAccess,
      },
      {
        id: 'kuadrant-telemetry-policy-edit-form',
        label: 'Edit Telemetry Policy',
        description: 'Edit via form',
        cta: () =>
          history.push({
            pathname: `/k8s/ns/${namespace}/telemetrypolicy/name/${name}/edit`,
          }),
        insertBefore: 'edit-yaml',
        accessReview: updateAccess,
      },
      {
        id: 'delete-telemetrypolicy',
        label: 'Delete',
