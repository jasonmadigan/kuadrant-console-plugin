...
const KuadrantRateLimitPolicyCreatePage: React.FC = () => {
  ...
  const gvkInfo = resourceGVKMapping['RateLimitPolicy'];
      ...
      <PageSection hasBodyWrapper={false}>
        <div className="co-m-nav-title">
          ...
          <p className="help-block">
            {t('RateLimitPolicy enables rate limiting for Gateway API resources')}
          </p>
        </div>
        <FormGroup
      ...
      {createView === 'form' ? (
        <PageSection hasBodyWrapper={false}>
          <Form className="co-m-pane__form">
            ...
            <LimitsSection limits={limits} onChange={setLimits} />
