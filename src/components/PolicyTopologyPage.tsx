    ...
    return (
      <Bullseye>
        <EmptyState>
          ...
          <EmptyStateBody>
            <p>You do not have permission to view Topology.</p>
            <p>
              Specifically, you do not have permission to read the ConfigMap "
              <strong>{config.TOPOLOGY_CONFIGMAP_NAME}</strong>" in the namespace "
