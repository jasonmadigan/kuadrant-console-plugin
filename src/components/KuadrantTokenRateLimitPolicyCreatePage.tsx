...
import { TargetRef, LimitConfig, Predicate, DefaultsOrOverrides } from './ratelimitpolicy/types';
import TargetRefField from './ratelimitpolicy/TargetRefField';
import LimitsSection from './ratelimitpolicy/LimitsSection';
import WhenField from './ratelimitpolicy/WhenField';
...
const KuadrantTokenRateLimitPolicyCreatePage: React.FC = () => {
  ...
  const gvkInfo = resourceGVKMapping['TokenRateLimitPolicy'];
      ...
      <PageSection hasBodyWrapper={false}>
        <div className="co-m-nav-title">
          ...
          <p className="help-block">
            {t('TokenRateLimitPolicy enables token-based rate limiting for Gateway API resources')}
          </p>
        </div>
        <FormGroup
      ...
      {createView === 'form' ? (
        <PageSection hasBodyWrapper={false}>
          <Form className="co-m-pane__form">
            ...
            <LimitsSection limits={limits} onChange={setLimits} tokenMode />
